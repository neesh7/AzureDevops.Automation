...
#URI
organization, project, pullRequestId = "orgname", "Project", 12121
url = f"https://dev.azure.com/{organization}/{project}/_apis/git/pullrequests/{pullRequestId}?api-version=7.1-preview.1"
